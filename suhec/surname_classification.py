...
def tokenize_data(df, surname_col: str = "surname"):
    # Initialize BERT tokenizer
    tokenizer = BertTokenizer.from_pretrained("bert-base-cased")
    return tokenizer.batch_encode_plus(
        df[surname_col].tolist(),
...
def create_dataset(encodings, df, labels: str = "nationality_index"):
...
def _defreeze_all_bert_layers(model):
    """
